...
public class DrawingUtility
{
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getPlayerSprite(player.getState(), player.getSpriteCounter()), player.getState(),
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getPawnSprite(pawn.getState(), pawn.getSpriteCounter()), pawn.getState(),
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getRookSprite(rook.getState(), rook.getSpriteCounter()), rook.getState(),
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getKnightSprite(knight.getState(), knight.getSpriteCounter()), knight.getState(),
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getBishopSprite(bishop.getState(), bishop.getSpriteCounter()), bishop.getState(),
	...
	{
		drawSprite(gc, ResourceLoader.getInstance().getQueenSprite(queen.getState(), queen.getSpriteCounter()), queen.getState(),
